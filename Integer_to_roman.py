...
class Solution(object):
    def intToRoman(self, num):
        ...
        # Step 1: Create a list of tuples mapping integer values to Roman numerals.
        # Order matters: we put larger values first so we can subtract greedily.
        val_to_roman = [
            (1000, "M"),
            (900, "CM"),
            (500, "D"),
        ...
        # Step 4: Once num becomes 0, return the final Roman numeral string
        return result
